...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"ConditionalOverridden", CLEAR_ON_MANAGER_START | CLEAR_ON_IGNITION_ON},
    {"ConditionalStatus", CLEAR_ON_MANAGER_START | CLEAR_ON_IGNITION_ON},
    ...
    {"ExperimentalModeSteeringWheel", PERSISTENT},
